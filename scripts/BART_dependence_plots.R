...
trained_plus_phat_time_of_throw <- load("data/BART_time_of_throw/trained_plus_phat_time_of_throw")
trained_plus_phat_time_of_throw <- load("data/BART_time_of_arrival/trained_plus_phat_time_of_arrival")
